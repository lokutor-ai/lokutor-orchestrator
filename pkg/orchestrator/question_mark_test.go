...
func TestRestoresQuestionMarkOnObservedTranscripts(t *testing.T) {
	cases := []struct {
		...
		{"es", "Por qué no me dices el precio.", "Por qué no me dices el precio?"},
		{"es", "Tenéis parking.", "Tenéis parking?"},
...
func TestLeavesStatementsAlone(t *testing.T) {
	cases := []struct {
		...
		// 2026-09-23: a caller giving their name was marked as asking it.
		{"es", "Me llamo Manolo."},
		{"es", "Por favor, quería reservar una habitación."},
		{"es", "Es para dos personas."},
		{"es", "Está bien, gracias."},
		{"es", "Que sí, que me va bien."},
